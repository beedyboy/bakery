...
$select->execute(array($id));
	...
	<a href="editOrder.php?invoice=<?php echo $id; ?> &type=edit">Edit Order </a>
	<button class="btn btn-danger pull-right cancelSoldOrder" id="<?php echo $id; ?>" pid="<?php echo $GetSession->position; ?>">Cancel Order </button>
	<?php endif; ?>
